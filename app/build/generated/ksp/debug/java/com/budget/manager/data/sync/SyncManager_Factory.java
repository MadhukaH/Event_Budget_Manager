...
public final class SyncManager_Factory implements Factory<SyncManager> {
  ...
  public SyncManager_Factory(Provider<WorkspaceDao> workspaceDaoProvider,
      Provider<ExpenseDao> expenseDaoProvider, Provider<GrantDao> grantDaoProvider,
  ...
  public SyncManager get() {
    return newInstance(workspaceDaoProvider.get(), expenseDaoProvider.get(), grantDaoProvider.get(), firestoreDataSourceProvider.get(), networkObserverProvider.get());
  }
  ...
  public static SyncManager_Factory create(javax.inject.Provider<WorkspaceDao> workspaceDaoProvider,
      ...
      javax.inject.Provider<GrantDao> grantDaoProvider,
    ...
    return new SyncManager_Factory(Providers.asDaggerProvider(workspaceDaoProvider), Providers.asDaggerProvider(expenseDaoProvider), Providers.asDaggerProvider(grantDaoProvider), Providers.asDaggerProvider(firestoreDataSourceProvider), Providers.asDaggerProvider(networkObserverProvider));
  }
  ...
  public static SyncManager_Factory create(Provider<WorkspaceDao> workspaceDaoProvider,
      ...
      Provider<FirestoreDataSource> firestoreDataSourceProvider,
      Provider<NetworkObserver> networkObserverProvider) {
    return new SyncManager_Factory(workspaceDaoProvider, expenseDaoProvider, grantDaoProvider, firestoreDataSourceProvider, networkObserverProvider);
  }

  public static SyncManager newInstance(WorkspaceDao workspaceDao, ExpenseDao expenseDao,
      GrantDao grantDao, FirestoreDataSource firestoreDataSource, NetworkObserver networkObserver) {
    return new SyncManager(workspaceDao, expenseDao, grantDao, firestoreDataSource, networkObserver);
  }
}
