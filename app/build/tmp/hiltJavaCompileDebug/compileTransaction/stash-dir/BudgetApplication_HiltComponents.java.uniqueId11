...
import com.budget.manager.di.AppModule;
...
import com.budget.manager.worker.BudgetSyncWorker_HiltModule;
import dagger.Binds;
...
public final class BudgetApplication_HiltComponents {
  ...
  @Component(
      modules = {
          ...
          BudgetSyncWorker_HiltModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          WorkspaceViewModel_HiltModules.KeyModule.class
      }
  )
  ...
  @Subcomponent(
      modules = {
          ...
          WorkspaceViewModel_HiltModules.BindsModule.class
      }
  )
  @ViewModelScoped
